        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card card-chart bg-table">
                ...
                <h1 style="font-size: 100px" ><strong>C 001</strong></h1>
                 ...
                 <table class="table">
                    ...
                    <thead>
                      <tr>
                        <th scope="col" class="text-left" ><h3><strong>NO ANTRIAN</strong></h3></th>
                        <th scope="col"><h3><strong>LOKET</strong></h3></th>
                      ...
                      <tbody>
                        ...
                        <tr class="blink_A">                        
                          <td class="text-left"><h1 style="font-size: 80px;text-shadow: 2px 2px  red;" ><strong><div id="txtnoA"></div></strong></h1></td>
                          <td><h1 style="font-size: 80px;text-shadow: 2px 2px 2px  red;" class="text-warning" ><strong><div id="txtloketA"></div></strong></h1></td>
                        </tr>


                        <tr class="blink_B">                        
                        <td class="text-left"><h1 style="font-size: 80px;text-shadow: 2px 2px  green;" ><strong><div id="txtnoB"></div></strong></h1></td>
                          <td><h1 style="font-size: 80px;text-shadow: 2px 2px  green;" class="text-warning" ><strong><div id="txtloketB"></div></strong></h1></td>
                        </tr>
                        <tr class="blink_C">                        
                        <td class="text-left"><h1 style="font-size: 80px;text-shadow: 2px 2px  orange;" ><strong><div id="txtnoC"></div></strong></h1></td>
                          <td><h1 style="font-size: 80px;text-shadow: 2px 2px  orange;" class="text-warning" ><strong><div id="txtloketC"></div></strong></h1></td>
                        </tr>
                        <tr class="blink_F">                        
                        <td class="text-left"><h1 style="font-size: 80px;text-shadow: 2px 2px  orange;" ><strong><div id="txtnoF"></div></strong></h1></td>
                          <td><h1 style="font-size: 80px;text-shadow: 2px 2px  orange;" class="text-warning" ><strong><div id="txtloketF"></div></strong></h1></td>
                        </tr>
                      </tbody>
                </table>
            ...
            <div class="col-md-7" >
                    ...
                    <video width="100%" height="100%" autoplay muted  id="mainvid" onended="videoended();">
   
                    Your browser does not support the video tag.
                    </video>
                    <!-- <iframe width="100%" height="100%"
                    src="https://www.youtube.com/embed/8o49U8xAfZ4?autoplay=1&mute=1&loop=1" frameBorder="0">
                    </iframe> -->
            </div>
