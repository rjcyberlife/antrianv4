...
setInterval(function(){
      $("#sectionA").load(window.location.href + " #sectionA" );
      $("#sectionB").load(window.location.href + " #sectionB" );
      $("#sectionC").load(window.location.href + " #sectionC" );
      $("#sectionF").load(window.location.href + " #sectionF" );
}, 1000);
});
